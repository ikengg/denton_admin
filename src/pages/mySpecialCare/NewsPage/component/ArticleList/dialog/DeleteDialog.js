...
import { deleteArticle } from "../../../../../../redux/actions/newsAction";
    ...
    return (
        <div>
            <Dialog open={openDeleteDialog} onClose={handleClickOpenDeleteDialog} aria-labelledby="form-dialog-title">
                ...
                <DialogContent>
                    <DialogContentText>
                        ยืนยันการลบบทความ <b><i>"{dialogData.title}"</i></b>
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    ...
                    <Button
                        onClick={() => {
                            dispatch(deleteArticle(dialogData.id, dialogData.imageName,  handleCloseDeleteDialog));
                        }}
                        color="secondary"
                    >
                        Delete
